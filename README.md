...
- Dashboard layout is optimized for observability (status strip -> trends -> daily summary). The `Power consumption per 15m` panel is a 15-minute block heatmap, and phase currents (L1/L2/L3) are scaled for a typical NL `3x25A` connection.
